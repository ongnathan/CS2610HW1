...
//						System.out.println(potential.word + " " + potential.usage);
	 ...
	 * @param filename The String representing the file to import from.
	...
	public static Dictionary importFromTextFile(String filename)
	{
		...
		{
			//prep the first line
			BufferedReader reader = new BufferedReader(new InputStreamReader(d.getClass().getClassLoader().getResourceAsStream(filename)));
