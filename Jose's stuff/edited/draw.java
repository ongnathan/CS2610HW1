...
//	}
	...
	public void setMouseVal()
	{
		Point mouseLoc = MouseInfo.getPointerInfo().getLocation();
		Point screenLoc = this.getLocationOnScreen();
		pt_x[pt_pos] = mouseLoc.x - screenLoc.x;
		pt_x[pt_pos] = mouseLoc.y - screenLoc.y;
		System.out.println(pt_x[pt_pos]+" "+pt_y[pt_pos]);
		pt_pos ++;
	}
...
//		timer.schedule(new RemindTask(mouseDragged,mx,my,obj),0, 100);
		timer.schedule(new RemindTask(this), 0,100);
	}
